$(document).ready(function(){
  ...
  $(document).on("click", "#addNow", function(e) {
    ...
    var btnStr = "<td><button class='btn btn-danger remove'><span class='glyphicon glyphicon-remove'></span></button>";
    btnStr += "<button class='btn btn-primary complete'><span class='glyphicon glyphicon-ok'></span></button></td>";
    newTr.append(btnStr);
